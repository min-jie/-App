...
class BeinPage extends StatefulWidget {
  const BeinPage({super.key, required this.title});

  final String title;

  @override
  State<BeinPage> createState() => _BeinPageState();
}

class _BeinPageState extends State<BeinPage> {
